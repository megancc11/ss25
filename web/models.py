...
class Issues(models.Model):
    """ 问题 """
    project = models.ForeignKey(verbose_name='项目', to='Project',on_delete=models.CASCADE)#有外键约束,自动删除级链字段)
    issues_type = models.ForeignKey(verbose_name='问题类型', to='IssuesType',on_delete=models.CASCADE)#有外键约束,自动删除级链字段)
    module = models.ForeignKey(verbose_name='模块', to='Module', null=True, blank=True,on_delete=models.CASCADE)#有外键约束,自动删除级链字段)
