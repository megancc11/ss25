...
from web.forms.widgets import ColorRadioSelect#自定义ModelForm插件
from web import models


class ProjectModelForm(BootStrapForm, forms.ModelForm):
    bootstrap_class_exclude = ['color']#使用自定义样式

    # desc = forms.CharField(widget=forms.Textarea(attrs={'xx': 123}))#为插件加属性
    class Meta:
        ...
        widgets = {
            ...
            # 'color': forms.Select#默认显示
            # 'color': forms.RadioSelect  # 默认显示
        }
